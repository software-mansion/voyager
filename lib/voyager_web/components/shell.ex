defmodule VoyagerWeb.Components.Shell do
  ...
  defp topbar(assigns) do
    ...
    <div class="bg-base-100 border-base-300 min-h-14 grid-cols-[auto_1fr_auto] z-10 grid flex-none items-center gap-4 border-b px-4">
      ...
      <.link
        ...
        id="open-settings"
        title="Settings"
        class="btn btn-ghost btn-square btn-sm text-base-content/70 hover:text-base-content"
      >
  ...
  defp sidebar_toggle(assigns) do
    ...
    <.link
      ...
      class={[
        "btn btn-ghost btn-square btn-sm text-base-content/70 hover:text-base-content",
        visibility
      ]}
    >
    ...
    >
      ...
      <.tooltip id="disconnect-tip" position="bottom">
        <button
          ...
          class="btn btn-ghost btn-square btn-xs text-error/80 hover:text-error"
        >
